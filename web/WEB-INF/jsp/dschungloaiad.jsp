<%-- 
    Document   : dschungloaiad
    Created on : Dec 28, 2016, 10:38:56 PM
    Author     : asus
--%>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h2><strong>Danh sách chủng loại</strong></h2>
                                <div class="button-ds">
                                    <a class="btn btn-primary btn-sm" href="chungloai.htm">Thêm mới</a>
                                </div>
                            </header>
