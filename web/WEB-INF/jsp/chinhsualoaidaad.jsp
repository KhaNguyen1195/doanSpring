                                ...
                                <div class="form">
                                    <form:form action="${action}" modelAttribute="loaida" class="form-group form-validate form-horizontal" id="register-form">
                                        ...
                                        <div class="form-group">
                                            <label for="ma" class="control-label col-lg-2">Mã loại đá</label>
                                            <div class="col-lg-10">
                                                <form:input path="ma" placeholder="Mã loại đá" class=" form-control" id="ma"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="ten" class="control-label col-lg-2">Tên loại đá</label>
                                            <div class="col-lg-10">
                                                <form:input path="ten" placeholder="Tên loại đá" class=" form-control" id="ten"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="hinhdang" class="control-label col-lg-2">Hình dáng</label>
                                            <div class="col-lg-10">
                                                <form:input path="hinhdang" placeholder="Hình dáng" class=" form-control" id="hinhdang"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="kichthuoc" class="control-label col-lg-2">Kích thước</label>
                                            <div class="col-lg-10">
                                                <form:input path="kichthuoc" placeholder="Kích thước" class=" form-control" id="kichthuoc"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="chatluong" class="control-label col-lg-2">Chất lượng</label>
                                            <div class="col-lg-10">
