<%-- 
    Document   : khachhangad
    Created on : Dec 27, 2016, 1:53:23 PM
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form:form action="${action}" modelAttribute="khachhang" class="form-group form-validate form-horizontal" id="register-form">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="trangthai" class="control-label col-lg-4 col-sm-3">Trạng thái <span class="required">*</span></label>
                                            <div class="col-lg-8 col-sm-9">
                                                <input  type="checkbox" style="width: 20px" class="checkbox form-control" id="trangthai" name="trangthai" />
                                            </div>
                                        </div>
